package vaiha.game.tagya.views;
...
import vaiha.game.tagya.TagyaApp;
import vaiha.game.tagya.events.WebViewInvalidateEvent;
...
//    private List<OnContentHeightChangedListener> onContentHeightChangedListeners;
    ...
    */
    private static final int FAST_SCROLL_THRESHOLD = (int) (1000 * TagyaApp.getInstance().getScreenDensity());
    ...
    */
    private static final int MAX_HUMAN_SCROLL = (int) (500 * TagyaApp.getInstance().getScreenDensity());
...
//            }
//        }
////        TagyaApp.getInstance().getBus().post(INVALIDATE_EVENT);
//    }
}
