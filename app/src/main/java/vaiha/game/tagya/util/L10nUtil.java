...
//    }
    ...
    private static Configuration getCurrentConfiguration() {
        return new Configuration(TagyaApp.getInstance().getResources().getConfiguration());
    }
    ...
    private static SparseArray<String> getTargetStrings(@StringRes int[] strings, Configuration altConfig) {
        ...
        Resources targetResources = new Resources(TagyaApp.getInstance().getResources().getAssets(),
                TagyaApp.getInstance().getResources().getDisplayMetrics(),
                                                  altConfig);
    ...
    private static void resetConfiguration(Configuration defaultConfig) {
        new Resources(TagyaApp.getInstance().getResources().getAssets(),
                TagyaApp.getInstance().getResources().getDisplayMetrics(),
                      defaultConfig);
    }
