package vaiha.game.tagya.bridge;
        ...
        this.addListener("DOMLoaded", new JSEventListener() {
            ...
            public void onMessage(String messageType, JSONObject messagePayload) {
                ...
                for (String jsString : pendingJSMessages) {
                    // javascript:handleMessage( "setDecorOffset", "pointerKey_0" );
                    // javascript:handleMessage( "injectStyles", "pointerKey_0" );
                    //
                    //
